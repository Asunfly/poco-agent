...
const VIEW_CSS: React.CSSProperties = {
  height: "100%",
  "--tw-enter-opacity": "1",
  "--tw-enter-scale": "1",
...
const DocumentViewerComponent = ({ file }: { file?: FileNode }) => {
  ...
  if (!file)
    return (
      <div className="h-full flex flex-col items-center justify-center border border-dashed rounded-xl bg-muted/5 p-12 text-center text-muted-foreground">
